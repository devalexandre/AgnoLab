...
export const AGENT_FIELDS: AgentFieldDefinition[] = [
  ...
  { key: "learning_machine", label: "Learning Machine", type: "python", group: "Memory", placeholder: "learning_machine", helper: "Connect a Learning Machine node to manage learning as a reusable resource." },
  { key: "learning", label: "Enable Learning", type: "checkbox", group: "Memory", helper: "Quick toggle for built-in learning when this agent has a database connected." },
  { key: "add_learnings_to_context", label: "Add Learnings To Context", type: "checkbox", group: "Memory", helper: "Injects the most relevant learnings into the prompt context before the run." },
  ...
  { key: "skills", label: "Skills", type: "python", group: "Tools", placeholder: "skills_resource", helper: "Connect a Skills node to load local Agno skills into this Agent." },
  ...
  { key: "tool_hooks", label: "Tool Hooks", type: "python", group: "Tools", placeholder: "[hook_a, hook_b]" },
  {
    ...
    type: "python",
    group: "Tools",
    placeholder: "[PromptInjectionGuardrail(), PIIDetectionGuardrail()]",
    helper: "Guardrails or custom hook callables run before the model. Available guardrails: PromptInjectionGuardrail, PIIDetectionGuardrail, OpenAIModerationGuardrail.",
  },
  {
    key: "post_hooks",
    label: "Post Hooks",
    type: "python",
    group: "Tools",
    placeholder: "[OpenAIModerationGuardrail()]",
    helper: "Guardrails or custom hook callables run after the model. Available guardrails: PromptInjectionGuardrail, PIIDetectionGuardrail, OpenAIModerationGuardrail.",
  },
